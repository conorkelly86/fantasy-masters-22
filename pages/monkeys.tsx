              ...
              >
                ...
                <tbody>
                  ...
                  <tr className="bg-red-100">
                    <th className="whitespace-nowrap border-t-0 border-l-0 border-r-0 p-4 px-6 text-left align-middle text-xs text-red-900 ">
                      Cut Penalty
                    </th>
                    <td className="whitespace-nowrap border-t-0 border-l-0 border-r-0 p-4 px-6 align-middle text-xs "></td>
                    <td className="whitespace-nowrap border-t-0 border-l-0 border-r-0 p-4 px-6 align-middle text-xs text-red-900">
                      {master.cutPenalty}
                    </td>
                  </tr>
                </tbody>
